...
RSpec.describe RubyPhpipam::Subnet do
  ...
  context "method first_free_ip" do
  ...
  context "method first_subnet" do
  ...
  context "method slaves_recursive" do
    it 'returns all slave subnets recursively'
  end

  context "method all_subnets" do
